...
void interpret_input2(){
  ...
  x_dist = map(xxx, -100, 100, -motion_limit, motion_limit);
  steer1 = map(yyy, -100, 100, -motion_limit, motion_limit);
  steer2 = map(yyy, -100, 100, motion_limit, -motion_limit);
